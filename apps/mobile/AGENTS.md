...
3. Make your change + hot reload (Cmd+D or shake)
...
2. Manual reload — shake or Cmd+D in Expo Go / dev client
3. `npx expo start --clear` — bundle cache issues
4. `npx expo run:ios` / `npx expo run:android` — only when native modules change
